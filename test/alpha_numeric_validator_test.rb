...
class AlphaNumericValidatorTest < Test::Unit::TestCase
  ...
  def test_alpha_numeric_validation
    ...
    validations = {:name => [['Bob1 Jones2', 'abcdef'], ['Bob# Jones?', '!@#$!@']],
      :organization => [["McDonald's", 'Yahoo!', 'ABC-DEF + GHI'], ['A@B', 'XYZ~3']],
      :favorite_quote => [['This$is=a& good*string', '~!@#$%^&*()'], ["Hello\x00"]],
      :server_name => [['hello1', 'abcdef'], ['hello world', 'hello~world']],
      :website => [['abc123.example.com', 'example.com'], ['he llo.example.com', 'my@site.com']],
      :id_code => [['hello1', 'abcdef'], ['hello world', 'hello-world']]}
